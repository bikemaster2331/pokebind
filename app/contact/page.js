            ...
            <nav className="sticky top-0 z-50 bg-[#0C0C0C]/30 backdrop-blur-sm border-b border-white/5 px-6 md:px-8 h-20 flex items-center justify-between shrink-0">
                ...
                <div className="absolute left-4 top-1/2 -translate-y-1/2 flex md:hidden items-center gap-1">
                    ...
                    <button
                        ...
                        title="Contact"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-4.5 h-4.5"><path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
                    </button>
                </div>
                ...
                {/* Right Area: Back to Shop button for mobile convenience */}
                <div className="ml-auto flex md:hidden items-center">
                    <button
                        onClick={() => router.push('/shop')}
                        className="text-[10px] text-[#444] hover:text-white tracking-widest uppercase transition-colors"
                    >
                        Back to Shop
                    </button>
                </div>
