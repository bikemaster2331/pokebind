    ...
    <div className="min-h-screen bg-[#141414] text-[#e0d8c8] relative select-none">
      ...
      <main className="min-h-screen bg-[#141414] text-[#e0d8c8]">
        ...
        <nav className="sticky top-0 z-40 bg-[#141414]/90 backdrop-blur-md border-b border-[#1a1a1a] px-4 md:px-8 h-20 flex items-center justify-between">
          ...
          {/* Top Left: Home & Contact Icons */}
          <div className="flex items-center gap-2 md:gap-4 w-auto md:w-1/3">
            <button
              onClick={() => router.push('/home')}
              className="text-white hover:text-[#10b981] transition-colors p-2 -ml-2"
              title="Home"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-4.5 h-4.5 md:w-5 md:h-5"><path d="M12 18v4"/><path d="m17 18 1.956-11.468"/><path d="m3 8 7.82-5.615a2 2 0 0 1 2.36 0L21 8"/><path d="M4 18h16"/><path d="M7 18 5.044 6.532"/><circle cx="12" cy="10" r="2"/></svg>
            </button>
            <button
